...
/// <summary>
/// Resolves free-text source values onto existing catalog entries. Shared by the operator
/// migration and the API import, so both apply exactly the same matching rules.
/// </summary>
/// <remarks>
