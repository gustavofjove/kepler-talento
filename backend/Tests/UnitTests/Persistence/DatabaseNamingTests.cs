...
public sealed class DatabaseNamingTests
{
    ...
    public void Every_application_table_has_an_explicit_approved_uppercase_prefix()
    {
        ...
        Assert.Equal(20, mappedTables.Length);
        ...
        Assert.Contains("CND_CandidateTags", mappedTables);
        Assert.Contains("CND_CandidateNotes", mappedTables);
        ...
        Assert.Contains("OPS_Positions", mappedTables);
        Assert.Contains("OPS_PositionCandidates", mappedTables);
        ...
        Assert.Contains("ADM_Users", mappedTables);
        Assert.Contains("ADM_Roles", mappedTables);
        Assert.Contains("ADM_ImportBatches", mappedTables);
        Assert.Contains("ADM_ImportRowOutcomes", mappedTables);
    }
